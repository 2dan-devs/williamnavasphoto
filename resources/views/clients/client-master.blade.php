...
<head>
	...
	<link media="all" type="text/css" rel="stylesheet" href="{{ url('css/client-master.css') }}">
...
<div class="contain-to-grid">
	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="right">
	      <li>
	        <a href="{{url('/user/dashboard')}}">Your Account</a>
	      </li>
	      <li><a href="{{ url('/user/dashboard/orders_history') }}">Your Orders</a></li>
...
<div class="row">
	<div class="large-12 columns"><br><br><br>
		<p id="footer">&copy; William Navas Photo. All rights reserved. Designed and developed by
